    ...
    pub fn new(section_id: &str, title: &str) -> Self {
        let items: Vec<NavGridItem> = match section_id {
            "gravity" => Vec::from([
                ...
                NavGridItem::new("3body-moon", "Moon", "active"),
            ...
            "oscillators" => Vec::from([
                ...
                NavGridItem::new("double-pendulum", "double pendulum", "inactive"),
                //     NavGridItem::new("lissajous", "Lissajous figures"),
                //     NavGridItem::new("fourier", "fourier"),  // ...?
            ]),
            "electro-magnetism" => Vec::from([
                NavGridItem::new("charge-interaction", "charge interaction", "inactive"),
            ...
            "thermo-dynamics" => Vec::from([
                NavGridItem::new("ising-model", "Ising model", "inactive"),
            ...
            "fluid-dynamics" => Vec::from([
                NavGridItem::new("diffusion", "Diffusion", "inactive"),
            ...
            "emergent-behavior" => Vec::from([
                NavGridItem::new("boids", "boids", "inactive"),
